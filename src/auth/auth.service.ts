...
import { AccAddress, Account as TerraAccount, InjectLCDClient, LCDClient, BaseAccount } from '@pulsardefi/nestjs-terra'
import { LCDClientError } from 'src/common/errors'
//import { Coin, PublicKey } from 'src/common/models'
import { PublicKey } from 'src/common/models'
...
export class AuthService {
  ...
  public async accountInfo(address: AccAddress, height?: number): Promise<Account | LazyGradedVestingAccount | any> {
    try {
